...
def main():
    ...
    <div style='display: flex; justify-content: center; align-items: center; height: 135vh;'>
        <iframe title="Personal Finance Dash v1" width="1140" height="541.25" src="https://app.powerbi.com/reportEmbed?reportId=dcc85b78-ef16-448a-9dfb-a22ab410f2bd&autoAuth=true&ctid=6dd87273-5fb3-4e6b-ac1c-029d6a5df713" frameborder="0" allowFullScreen="true"></iframe>
    </div>
    """
